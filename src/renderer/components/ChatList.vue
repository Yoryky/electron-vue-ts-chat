    ...
    <ul>
      ...
      >
        ...
        <div class="list-right">
          ...
          <p class="lastmsg test" v-if="item.messages[item.messages.length-1].messageType">{{item.messages[item.messages.length-1].content[0].article}}</p>
          <p class="lastmsg" v-else>{{item.messages[item.messages.length-1].content}}</p>
        </div>
      </li>
    </ul>
  </div>
